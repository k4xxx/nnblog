...
#
# class ValidCodeImg:
#     def __init__(self,width=110,height=33,code_count=4,font_size=32,point_count=20,line_count=3,img_format='png'):
#         '''
...
#         font=ImageFont.truetype("blog/static/font/kumo.ttf",size=self.font_size)
#
#         temp = []
